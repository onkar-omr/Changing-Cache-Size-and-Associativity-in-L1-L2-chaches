...
#GLOBALS
bench_dir = "/home/onkar/Downloads/SMTSIM/benchmarks/"
scr_dir = "/home/onkar/Downloads/SMTSIM/Shell_files/Project/"
exe = "smtsim"
exe_path = os.path.join("/home/onkar/Downloads/SMTSIM/SMTSIM/build.linux-amd64", exe)
sims_group = "/home/onkar/Downloads/SMTSIM/results/Project/"
thread_length = 1e7
ff_dist = 1e7
host = ''
...
def create_configurations():
    ...
    c0 = [32, 32, 64, 64, 64, 24, 1, 32, 1, 32, 2, 1, 1, 8, 4, 128, 4]
    c1 = [32, 32, 64, 64, 64, 24, 1, 32, 1, 32, 2, 1, 1, 8, 4, 128, 8]
    c2 = [32, 32, 64, 64, 64, 24, 1, 32, 1, 32, 2, 1, 1, 8, 4, 256, 4]
    c3 = [32, 32, 64, 64, 64, 24, 1, 32, 1, 32, 2, 1, 1, 8, 4, 256, 8]
    c4 = [32, 32, 64, 64, 64, 24, 2, 32, 2, 32, 2, 1, 1, 8, 4, 128, 4]
    c5 = [32, 32, 64, 64, 64, 24, 2, 32, 2, 32, 2, 1, 1, 8, 4, 128, 8]
    c6 = [32, 32, 64, 64, 64, 24, 2, 32, 2, 32, 2, 1, 1, 8, 4, 256, 4]
    c7 = [32, 32, 64, 64, 64, 24, 2, 32, 2, 32, 2, 1, 1, 8, 4, 256, 8]
    c8 = [32, 32, 64, 64, 64, 24, 1, 64, 1, 64, 2, 1, 1, 8, 4, 128, 4]
    c9 = [32, 32, 64, 64, 64, 24, 1, 64, 1, 64, 2, 1, 1, 8, 4, 128, 8]
    c10 = [32, 32, 64, 64, 64, 24, 1, 64, 1, 64, 2, 1, 1, 8, 4, 256, 4]
    c11 = [32, 32, 64, 64, 64, 24, 1, 64, 1, 64, 2, 1, 1, 8, 4, 256, 8]
    c12 = [32, 32, 64, 64, 64, 24, 2, 64, 2, 64, 2, 1, 1, 8, 4, 128, 4]
    c13 = [32, 32, 64, 64, 64, 24, 2, 64, 2, 64, 2, 1, 1, 8, 4, 128, 8]
    c14 = [32, 32, 64, 64, 64, 24, 2, 64, 2, 64, 2, 1, 1, 8, 4, 256, 4]
    c15 = [32, 32, 64, 64, 64, 24, 2, 64, 2, 64, 2, 1, 1, 8, 4, 256, 8]


    configs_to_test = [c0, c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12, c13, c14, c15]
    confs = [] 
    ...
    for c in configs_to_test:    
        ...
        conf_dict['l2s']=c[15] # L2 cache size
        conf_dict['l2a']=c[16] # L2 cache associativity
...
cd "%s"
%s -conffile "/home/onkar/Downloads/SMTSIM/benchmarks/workloads-list_ffs0.conf" \
...
""" % (bench_dir, exe_path,  sims_group+simout_name, input1, "%e" %ff_dist, input1, "%e" %thread_length,conf['l2s'],conf['l2a'],conf['ics'],conf['ica'],conf['dcs'],conf['dca'], conf['lsq'], conf['iqs'], conf['fqs'],conf['fb'],conf['fb'],conf['mci'],conf['mci'],conf['mii'],conf['mfi'],conf['mli'],conf['ipr'],conf['fpr'],conf['rob'],get_ceil_power_of_two(conf['rob']*8), sims_group, simout_name)
    return script
    
def get_simout_name(exe,input1,ff_dist,c,count):
    s = ""
...
def main():
    ...
    for (input1) in single_thread_workloads:
        ...
        count = 0
        for c in c_list:
            simout_name = get_simout_name(exe,input1,ff_dist,c,count)
            count += 1
